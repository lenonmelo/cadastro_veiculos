...
<div class="card">
    <div class="card-body">
        {!! Form::open(['route' => ['vehicles.update', 'vehicle' => $vehicle->id], 'method' => 'PUT', 'class' => 'form-horizontal', 'files' => true]) !!}
        {{ csrf_field() }}
        <div class="form-group row">
            {!! Form::label('name', 'Nome:*', ['class' => 'col-sm-2 col-form-label']) !!}
            <div class="col-sm-3">
                {!! Form::text('name', $vehicle->name, ['class' => 'form-control' . ($errors->has('name') ? ' is-invalid' : '')]) !!}
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                {!! Form::text('year', $vehicle->year, ['class' => 'form-control' . ($errors->has('year') ? ' is-invalid' : '')]) !!}
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                {!! Form::text('mileage', $vehicle->mileage, ['class' => 'form-control' . ($errors->has('mileage') ? ' is-invalid' : '')]) !!}
            </div>
        </div>
